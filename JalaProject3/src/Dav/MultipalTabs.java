...
public class MultipalTabs {
   public void planToSuccedde() {
	   System.out.println("Congratulations, You are in the best place to learn the technologies for JOB. Please strictly follow the plan for the first 45 days to see the unbelievable results.\r\n" + 
	   		"\r\n" + 
